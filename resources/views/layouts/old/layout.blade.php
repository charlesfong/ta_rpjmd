...
<head>
  ...
  <title>AdminLTEE 2 | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset('asset/dist/img/marinuslogo.jpg')}}" class="img-circle" alt="User Image"></span>
