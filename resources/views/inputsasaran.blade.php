...
@section('content')
	<table class="table table-striped">
          <tbody>
            <tr>
              <td><h4>Input Sasaran</h4></td>
            </tr>
             <tr>
                <td colspan="1">
                   <form class="well form-horizontal" method="post" action="{{ route('storeSasaran') }}">
                    {{ csrf_field() }}
                      <fieldset>
                         ...
                         <div id="tujuan_div">
                          ...
                          <input type="button" id="btAdd" value="Tambah Sasaran" class="bt" style="display: none;" />
                          <input type="button" id="btRemove" value="Hapus Sasaran Terahkir" class="bt" style="display: none;"/>
       ...
       <script type="text/javascript">
        ...
        $("#tujuan").change(function() {
            ...
            {
                iCnt = iCnt + 1;
                    $('#tujuan_div').append('<div class="form-group" id="'+iCnt+'"><label class="col-md-1 control-label">Sasaran '+iCnt+'</label><div class="col-md-11 inputGroupContainer"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span><input type=text class="form-control" name="sasaran[]" required="true" value="" placeholder="Sasaran '+iCnt+'"/></div></div></div>');
            }
        });
